...
%     [W_tr,C_W,Fai1,F_tr] = TrainFWDFT(L_t,L_r,N_r,M,N_t,NN);
...
%         [est_g,I] = My_est_g1DFT(y_w,MAX_y_k,GG,K_p,MSE,max_e1,K,M,L_r,R_W,L_t); %%  鍒嗕负1缁勭殑淇￠亾浼拌
%         [est_g16,I16] = My_est_gDFT(y_w,MAX_y_k,GG,K_p,MSE,max_e1,K,G1,M,L_r,L_t,RR_W);%%  鍒嗕负16缁勭殑淇￠亾浼拌
%         [est_g14,I4] = My_est_g4DFT(y_w,MAX_y_k,GG,K_p,MSE,max_e1,K,G2,M,L_r,L_t,RR_W1);%%  鍒嗕负4缁勭殑
...
% figure(1)
% plot(SNR,S_R,'g-o','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
% hold on;
% plot(SNR,S_R1,'g-*','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
% hold on;
% plot(SNR,S_R4,'g->','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
% hold on;
% plot(SNR,S_R16,'g-<','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
% hold on;
% plot(SNR,S_R3,'b-*','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
% hold on;
% plot(SNR,S_R11,'r-o','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
% hold on;
% plot(SNR,S_R14,'r->','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
% hold on;
% plot(SNR,S_R161,'r-<','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
% hold on;
