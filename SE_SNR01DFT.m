...
RR = zeros(length(SNR1),K);
RR1 = zeros(length(SNR1),K);
RR4 = zeros(length(SNR1),K);
RR16 = zeros(length(SNR1),K);
RR3 = zeros(length(SNR1),K);
RR11 = zeros(length(SNR1),K);
RR14 = zeros(length(SNR1),K);
RR161 = zeros(length(SNR1),K);
ORR = zeros(CC, length(SNR1));
ORR1 = zeros(CC, length(SNR1));
ORR4 = zeros(CC, length(SNR1));
ORR16 = zeros(CC, length(SNR1));
LRR3 = zeros(CC, length(SNR1));
NRR11 = zeros(CC, length(SNR1));
NRR14 = zeros(CC, length(SNR1));
NRR16 = zeros(CC, length(SNR1));
n_t = 0:1:N_t-1;
for n = 1:N_t
...
R14k = R14k/CC ;
R161k = R161k/CC;
S_R = zeros(1, length(SNR1));
S_R1 = zeros(1, length(SNR1));
S_R4 = zeros(1, length(SNR1));
S_R16 = zeros(1, length(SNR1));
S_R3 = zeros(1, length(SNR1));
S_R11 = zeros(1, length(SNR1));
S_R14 = zeros(1, length(SNR1));
S_R161 = zeros(1, length(SNR1));
...
S_R_k(:,2) = abs(R11k(:,8));
S_R_k(:,3) = abs(R11k(:,16));
save myresult1.mat SS_RR
save myresult2.mat S_R_k