...
max_e1 = 1;%   max_e1 = norm(trace(C_W)*N0/L_r/M)
...
for s = 1:length(MM)
    ...
    v_crb = zeros(1,CC);
    L1 = 14;
    [W_tr,C_W,Fai1] = TrainFW(L_t,L_r,N_r,M,N_t,NN);
    for a = 1:CC 
...
plot(MM,Nmse_nHK,'g-o','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=1
hold on;
plot(MM,Nmse_nHK1,'r-o','Markersize',7,'Linewidth',1);%NewMethod，P=1
hold on;
plot(MM,Nmse_nHK3,'b-*','Markersize',7,'Linewidth',1);%LowerBound
hold on;
plot(MM,Nmse_nHK4,'r->','Markersize',7,'Linewidth',1);%NewMethod，P=16
hold on;
plot(MM,Nmse_nHK7,'g->','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=16
hold on;
plot(MM,Nmse_nHK22,'r-<','Markersize',7,'Linewidth',1);%NewMethod，P=4
hold on;
plot(MM,Nmse_nHK14,'g-<','Markersize',7,'Linewidth',1);%SS-SW-OMP+Th，P=4
hold on;
plot(MM,V_crb,'r-*','Markersize',7,'Linewidth',1);
